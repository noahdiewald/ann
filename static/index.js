  ...
  var require_Main = __commonJS({
    "elm:client/Main.elm"(exports) {
      (function(scope) {
        ...
        var $author$project$Main$Meta = F2(
        ...
        var $author$project$Main$ReceivedSelection = function(a) {
          return { $: "ReceivedSelection", a };
        };
        var $author$project$Interface$receivedDocSelection = _Platform_incomingPort("receivedDocSelection", $elm$json$Json$Decode$string);
        var $author$project$Interface$receivedSelection = $author$project$Interface$receivedDocSelection;
        var $author$project$Main$subscriptions = function(model) {
          return $author$project$Interface$receivedSelection($author$project$Main$ReceivedSelection);
        };
        var $author$project$Main$PropKeyT = F3(
          function(a, b, c) {
            return { $: "PropKeyT", a, b, c };
          }
        );
        var $author$project$Main$PropValueT = F3(
          function(a, b, c) {
            return { $: "PropValueT", a, b, c };
          }
        );
        ...
        var $author$project$Main$TagsT = F2(
          function(a, b) {
            return { $: "TagsT", a, b };
          }
        );
        ...
        var $author$project$Main$getIndex = F2(
          function(identifier, model) {
            return A2(
              ...
              $elm$core$List$length(model.order),
              A2($elm_community$list_extra$List$Extra$elemIndex, identifier, model.order)
            );
          }
        );
        ...
        var $miniBill$elm_unicode$Unicode$isSeparator = function(c) {
          ...
          return l(256) ? e(32) || e(160) : e(5760) || (A2(r, 8192, 8202) || (A2(r, 8232, 8233) || (e(8239) || (e(8287) || e(12288)))));
        };
        var $elm$core$String$toLower = _String_toLower;
        var $elm$core$String$words = _String_words;
        var $author$project$Main$processText = F2(
              ...
              A2(
                ...
                $elm$core$String$words(
                  A2(
                    ...
                    function(x) {
                      return $miniBill$elm_unicode$Unicode$isAlpha(x) || $miniBill$elm_unicode$Unicode$isSeparator(x);
                    },
        ...
        var $author$project$Interface$requestDocSelection = _Platform_outgoingPort(
          "requestDocSelection",
          function($) {
            return $elm$json$Json$Encode$null;
          }
        );
        var $author$project$Interface$requestSelection = $author$project$Interface$requestDocSelection;
        ...
        var $author$project$Main$splitGrouping = F3(
          function(model, group, identifier) {
            var index = A2($author$project$Main$getIndex, identifier, model);
            var prevIndex = index - 1 >= 0 ? $elm$core$Maybe$Just(index - 1) : $elm$core$Maybe$Nothing;
            var split = F2(
              function(_v2, p) {
                var _v3 = _v2.a;
                var k1 = _v3.a;
            ...
            var currGroup = $elm$core$List$head(
              $elm$core$Dict$toList(
                A2(
                  ...
                  F2(
                    function(_v1, v) {
                      var k1 = _v1.a;
                      var k2 = _v1.b;
                      return _Utils_cmp(index, k1) > 0 && _Utils_cmp(index, k2) < 1;
                    }
                  ),
                  group(model)
                )
            ...
            var _v0 = _Utils_Tuple2(currGroup, prevIndex);
            if (_v0.a.$ === "Just" && _v0.b.$ === "Just") {
              var curr = _v0.a.a;
              var prev = _v0.b.a;
              return A2(split, curr, prev);
            } else {
              return group(model);
            }
          }
              ...
              while (true) {
                if (_Utils_eq(index1, index2) || index1 < 0) {
                  ...
                  if (_Utils_cmp(index1, index2) > 0) {
                    var $temp$index1 = index2, $temp$index2 = index1, $temp$l = l;
                    index1 = $temp$index1;
                    index2 = $temp$index2;
                    l = $temp$l;
                    continue swapAt;
        ...
        var $author$project$Main$update = F2(
          function(msg, model) {
            switch (msg.$) {
              ...
              case "GenerateTokens":
                var new_tokens = A2($author$project$Main$processText, model.counter, model.text);
                var new_counter = $elm$core$Dict$size(new_tokens) - 1;
                return _Utils_Tuple2(
                  _Utils_update(
                    model,
                    {
                      blocks: $elm$core$Dict$fromList(
                        _List_fromArray(
                          [
                            _Utils_Tuple2(
                              _Utils_Tuple2(0, new_counter),
                              { properties: $elm$core$Dict$empty, tags: $elm$core$Set$empty }
                            )
                          ]
                        )
                      ),
                      ...
                      order: A2($elm$core$List$range, 0, new_counter),
                      tokens: new_tokens
                    }
                  ),
                  $elm$core$Platform$Cmd$none
                );
              case "ReceivedSelection":
                var s = msg.a;
                var _v1 = A2($elm$json$Json$Decode$decodeString, $author$project$Main$selectionD, s);
                if (_v1.$ === "Ok" && _v1.a.$ === "Just") {
                  var _v2 = _v1.a.a;
                  var s1 = _v2.a;
                  var s2 = _v2.b;
                  var single = $elm$core$Maybe$Just(
                    $author$project$Main$Single(s1)
                  );
                  var range = $elm$core$Maybe$Just(
                    $author$project$Main$Range(
                      _Utils_Tuple2(s1, s2)
                    )
                  );
                  var newModel = _Utils_eq(s1, s2) ? _Utils_update(
                    model,
                    { editing: single }
                  ) : _Utils_update(
                    model,
              ...
              case "TokenFocused":
                return _Utils_Tuple2(
                  model,
                  $author$project$Interface$requestSelection(_Utils_Tuple0)
                );
              case "TokenStringChanged":
                var identifier = msg.a;
                var s = msg.b;
                var updateS = function(token2) {
                  return A2(
                    $elm$core$Maybe$map,
                    function(x) {
                      return _Utils_update(
                ...
                var tokens = A3($elm$core$Dict$update, identifier, updateS, model.tokens);
                return _Utils_Tuple2(
                  _Utils_update(
                    model,
                    { tokens }
              ...
              case "RemoveToken":
                var identifier = msg.a;
                var tokens = A2($elm$core$Dict$remove, identifier, model.tokens);
                var index = A2($author$project$Main$getIndex, identifier, model);
                var keyDown = function(_v4) {
                  var k1 = _v4.a;
                  var k2 = _v4.b;
                  return _Utils_cmp(k1, index) > 0 ? _Utils_Tuple2(k1 - 1, k2 - 1) : _Utils_cmp(k2, index) > -1 ? _Utils_Tuple2(k1, k2 - 1) : _Utils_Tuple2(k1, k2);
                };
                var order = A2($elm_community$list_extra$List$Extra$removeAt, index, model.order);
                var singleton = function(_v3) {
                  var k1 = _v3.a;
                  var k2 = _v3.b;
                  return _Utils_eq(k1, k2) && _Utils_eq(k1, index);
                };
                var updateKey = F3(
                  function(k, v, d) {
                    return singleton(k) ? d : A3(
                      $elm$core$Dict$insert,
                      keyDown(k),
                      v,
                      d
                ...
                var lines = A3($elm$core$Dict$foldl, updateKey, $elm$core$Dict$empty, model.lines);
                var blocks = A3($elm$core$Dict$foldl, updateKey, $elm$core$Dict$empty, model.blocks);
                return _Utils_Tuple2(
                  _Utils_update(
                    model,
                    { blocks, lines, order, tokens }
                  ),
                  $elm$core$Platform$Cmd$none
                );
              case "SwapTokenLeft":
                var identifier = msg.a;
                var index = A2($author$project$Main$getIndex, identifier, model);
                var swap = A2($elm_community$list_extra$List$Extra$swapAt, index - 1, index);
                return _Utils_Tuple2(
                  _Utils_update(
                    model,
                    {
                      order: swap(model.order)
                    }
                  ),
                  $elm$core$Platform$Cmd$none
                );
              case "SwapTokenRight":
                var identifier = msg.a;
                var index = A2($author$project$Main$getIndex, identifier, model);
                var swap = A2($elm_community$list_extra$List$Extra$swapAt, index, index + 1);
                return _Utils_Tuple2(
                  _Utils_update(
                    model,
                    {
              ...
              case "Split":
                switch (msg.a.$) {
                  case "BlockT":
                    var _v5 = msg.a;
                    var identifier = msg.b;
                    var lines = A3(
                      $author$project$Main$splitGrouping,
                      model,
                      function($) {
                        return $.lines;
                      },
              ...
              case "Merge":
                switch (msg.a.$) {
                  case "BlockT":
                    ...
                    var merge = F2(
                      function(_v9, _v11) {
                        ...
                        return A3(
                          $elm$core$Dict$insert,
                          _Utils_Tuple2(pKey1, cKey2),
                          {
                            properties: A2($elm$core$Dict$union, pv.properties, cv.properties),
                            tags: A2($elm$core$Set$union, pv.tags, cv.tags)
                          },
                          A2(
                            $elm$core$Dict$remove,
                            _Utils_Tuple2(cKey1, cKey2),
                            A2(
                              $elm$core$Dict$remove,
                              _Utils_Tuple2(pKey1, pKey2),
                              model.blocks
                            )
                          )
                        );
                    ...
                    var index = A2($author$project$Main$getIndex, identifier, model);
                    var prevBlock = $elm$core$List$head(
                      A2(
                        $elm$core$List$filter,
                        A2(
                          $elm$core$Basics$composeR,
                          $author$project$Main$key2,
                          $elm$core$Basics$eq(index - 1)
                        ),
                        $elm$core$Dict$toList(model.blocks)
                      )
                    );
                    var currBlock = $elm$core$List$head(
                      A2(
                        $elm$core$List$filter,
                        A2(
                          $elm$core$Basics$composeR,
                          $author$project$Main$key1,
                          $elm$core$Basics$eq(index)
                        ),
                        $elm$core$Dict$toList(model.blocks)
                      )
                    );
                    var _v8 = _Utils_Tuple2(prevBlock, currBlock);
                  ...
                  case "LineT":
                    ...
                    var index = A2($author$project$Main$getIndex, identifier, model);
                    var block = $elm$core$List$head(
                      A2(
                        $elm$core$List$filter,
                        A2(
                          $elm$core$Basics$composeR,
                          $author$project$Main$key2,
                          $elm$core$Basics$le(index)
                        ),
                        A2(
                          $elm$core$List$filter,
                          A2(
                    ...
                    var currLine = A2(
                      ...
                      A2(
                        ...
                        A2($elm$core$Maybe$map, lines, block)
                      )
                    );
                    var prevLine = A2(
                      $elm$core$Maybe$andThen,
                    ...
                    var _v14 = _Utils_Tuple2(prevLine, currLine);
              ...
              case "InsertToken":
                ...
                var updateKey = F3(
                  function(_v20, v, d) {
                    var k1 = _v20.a;
                    var k2 = _v20.b;
                    return _Utils_cmp(k1, index) > 0 ? A3(
                      $elm$core$Dict$insert,
                      _Utils_Tuple2(k1 + 1, k2 + 1),
                      v,
                      d
                    ) : _Utils_cmp(k2, index) > -1 ? A3(
                      $elm$core$Dict$insert,
                      _Utils_Tuple2(k1, k2 + 1),
                      v,
                      d
                    ) : A3(
                      $elm$core$Dict$insert,
                ...
                var editing = $elm$core$Maybe$Just(
                  $author$project$Main$Single(counter)
                );
                var order = function(_v19) {
                  var x = _v19.a;
                  var y = _v19.b;
                  return _Utils_ap(
                    x,
                    A2($elm$core$List$cons, counter, y)
                  );
                }(
                  A2($elm_community$list_extra$List$Extra$splitAt, index + 1, model.order)
                );
                var token = {
                  identifier: counter,
                  meta: A2($author$project$Main$Meta, $elm$core$Set$empty, $elm$core$Dict$empty),
                ...
                var tokens = A3($elm$core$Dict$insert, counter, token, model.tokens);
                var blocks = A3($elm$core$Dict$foldl, updateKey, $elm$core$Dict$empty, model.blocks);
                return _Utils_Tuple2(
                  _Utils_update(
                    model,
                    { blocks, counter, editing, lines, order, tokens }
                  ),
                  $elm$core$Platform$Cmd$none
                );
              case "ChangeEditPane":
                ...
                switch (msg.a.$) {
                  case "TagsT":
                    ...
                    var tagSet = function() {
                      switch (part.$) {
                        case "TextT":
                          return $elm$core$Maybe$Just(model.meta.tags);
                        case "LineT":
                          return A2(
                            $elm$core$Maybe$map,
                            function($) {
                            ...
                            A2($elm$core$Dict$get, index, model.lines)
                          );
                        case "BlockT":
                          return A2(
                            $elm$core$Maybe$map,
                            ...
                            A2($elm$core$Dict$get, index, model.blocks)
                          );
                        default:
                          return $elm$core$Maybe$Nothing;
                      }
                    ...
                    var tags = A2(
                      ...
                      "\n",
                      $elm$core$Set$toList(
                        A2($elm$core$Maybe$withDefault, $elm$core$Set$empty, tagSet)
                      )
                    );
                    return _Utils_Tuple2(
                      _Utils_update(
                        model,
                        {
                          editingMeta: A2($author$project$Main$TagsT, part, index),
                          temp: tags
                        }
                      ),
                      $elm$core$Platform$Cmd$none
                  ...
                  case "PropKeyT":
                    ...
                    return _Utils_Tuple2(
                      _Utils_update(
                        model,
                        {
                          editingMeta: A3($author$project$Main$PropKeyT, part, index, s),
                          temp: ""
                        }
                      ),
                      $elm$core$Platform$Cmd$none
                  ...
                  case "PropValueT":
                      ...
                      switch (part.$) {
                        case "TextT":
                          return A2(
                            $elm$core$Maybe$withDefault,
                            "",
                            A2($elm$core$Dict$get, s, model.meta.properties)
                          );
                        case "BlockT":
                          return A2(
                            $elm$core$Maybe$withDefault,
                    ...
                    return _Utils_Tuple2(
                      _Utils_update(
                        model,
                        {
                          editingMeta: A3($author$project$Main$PropValueT, part, index, s),
                          temp: value
                        }
                      ),
                      $elm$core$Platform$Cmd$none
              ...
              case "Remove":
                if (msg.a.$ === "PropKeyT") {
                  ...
                  switch (part.$) {
                        ...
                        _Utils_update(
                          model,
                          {
                            meta: _Utils_update(
                              meta,
                              {
                                properties: A2($elm$core$Dict$remove, s, meta.properties)
                              }
                            )
                          }
                        ),
                    ...
                    case "LineT":
                      var line = A2($elm$core$Dict$get, index, model.lines);
                      var lines = function() {
                        if (line.$ === "Nothing") {
                          return model.lines;
                        } else {
                          ...
                          return A3(
                            ...
                            _Utils_update(
                              l,
                              {
                                properties: A2($elm$core$Dict$remove, s, l.properties)
                              }
                            ),
                            model.lines
                          );
                    ...
                    case "BlockT":
                      var block = A2($elm$core$Dict$get, index, model.blocks);
                      var blocks = function() {
                        if (block.$ === "Nothing") {
                          return model.blocks;
                        } else {
                          ...
                          return A3(
                            ...
                            _Utils_update(
                              b,
                              {
                                properties: A2($elm$core$Dict$remove, s, b.properties)
                              }
                            ),
                            model.blocks
                          );
                ...
                switch (msg.a.$) {
                  case "PropKeyT":
                    ...
                    var nmodel = _Utils_update(
                      model,
                      { editingMeta: $author$project$Main$NoneT, temp: "" }
                    );
                    switch (part.$) {
                      case "TextT":
                        var meta = model.meta;
                          ...
                          _Utils_update(
                            nmodel,
                            {
                              meta: _Utils_update(
                                meta,
                                {
                                  properties: A3($elm$core$Dict$insert, model.temp, "", meta.properties)
                                }
                              )
                            }
                          ),
                          ...
                          if (line.$ === "Nothing") {
                            ...
                            return A3(
                              ...
                              _Utils_update(
                                l,
                                {
                                  properties: A3($elm$core$Dict$insert, model.temp, "", l.properties)
                                }
                              ),
                              model.lines
                            );
                          ...
                          if (block.$ === "Nothing") {
                            ...
                            return A3(
                              ...
                              _Utils_update(
                                b,
                                {
                                  properties: A3($elm$core$Dict$insert, model.temp, "", b.properties)
                                }
                              ),
                              model.blocks
                            );
                          ...
                          _Utils_update(
                            nmodel,
                            {
                              meta: _Utils_update(
                                meta,
                                {
                                  properties: A3($elm$core$Dict$insert, s, model.temp, meta.properties)
                                }
                              )
                            }
                          ),
                          ...
                          if (line.$ === "Nothing") {
                            ...
                            return A3(
                              ...
                              _Utils_update(
                                l,
                                {
                                  properties: A3($elm$core$Dict$insert, s, model.temp, l.properties)
                                }
                              ),
                              model.lines
                            );
                          ...
                          if (block.$ === "Nothing") {
                            ...
                            return A3(
                              ...
                              _Utils_update(
                                b,
                                {
                                  properties: A3($elm$core$Dict$insert, s, model.temp, b.properties)
                                }
                              ),
                              model.blocks
                            );
                  ...
                  case "TagsT":
                    ...
                    var part = _v38.a;
                    var index = _v38.b;
                    var tags = $elm$core$Set$fromList(
                      A2(
                        $elm$core$List$filter,
        ...
        var $author$project$Main$viewOrDefault = F3(
          function(_default, condition, viewHtml) {
            return condition ? viewHtml : _default;
          }
        );
        var $author$project$Main$TokenFocused = { $: "TokenFocused" };
        ...
        var $author$project$Main$viewTokenCell = function(_v0) {
          var editing = _v0.editing;
          var inRange = _v0.inRange;
          var token = _v0.token;
          return A2(
            $elm$html$Html$td,
            _List_fromArray(
              [
                $elm$html$Html$Attributes$classList(
                  _List_fromArray(
                    [
                      _Utils_Tuple2("token-cell", true),
                      _Utils_Tuple2("editing-token", editing),
                      _Utils_Tuple2("editing-range", inRange)
                    ]
                  )
                ),
                $elm$html$Html$Attributes$id(
                  $elm$core$String$fromInt(token.identifier)
                ),
                $elm$html$Html$Events$onMouseUp($author$project$Main$TokenFocused)
              ]
            ),
            _List_fromArray(
              [
                $elm$html$Html$text(token.string)
              ]
            )
          );
        };
        var $author$project$Main$viewToken = F2(
          function(model, token) {
            var range = function(sel) {
              return _Utils_Tuple2(
                A2($author$project$Main$getIndex, sel.a, model),
                A2($author$project$Main$getIndex, sel.b, model)
              );
            };
            var none = $elm$html$Html$text("");
            var index = A2($author$project$Main$getIndex, token.identifier, model);
            var _default = { editing: false, inRange: false, token };
            var orDefault = $author$project$Main$viewOrDefault(
              $author$project$Main$viewTokenCell(_default)
            );
            return A2(
              $elm$html$Html$table,
              _List_fromArray(
                    ...
                    _List_fromArray(
                      [
                        function() {
                          ...
                          if (_v0.$ === "Nothing") {
                            return A2(orDefault, false, none);
                          } else {
                            if (_v0.a.$ === "Single") {
                              var identifier = _v0.a.a;
                              return A2(
                                orDefault,
                                _Utils_eq(identifier, token.identifier),
                                $author$project$Main$viewTokenCell(
                                  _Utils_update(
                                    _default,
                                    { editing: true }
                                  )
                              ...
                              return A2(
                                orDefault,
                                _Utils_cmp(r.a, index) < 1 && _Utils_cmp(r.b, index) > -1,
                                $author$project$Main$viewTokenCell(
                                  _Utils_update(
                                    _default,
                                    { inRange: true }
        ...
        var $author$project$Main$viewLine = F2(
          function(model, line) {
            return A2(
              ...
              _List_fromArray(
                [
                  $elm$html$Html$Attributes$class("token-line")
                ]
              ),
              A2(
                $elm$core$List$map,
                $author$project$Main$viewToken(model),
                $elm_community$maybe_extra$Maybe$Extra$values(
                  A2(
                    $elm$core$List$map,
                    function(i) {
                      return A2($elm$core$Dict$get, i, model.tokens);
                    },
                    A2(
                      $elm_community$list_extra$List$Extra$splitAt,
                      line.b - line.a + 1,
                      A2($elm_community$list_extra$List$Extra$splitAt, line.a, model.order).b
                    ).a
                  )
                )
              )
        ...
        var $author$project$Main$viewBlock = F2(
          function(model, block) {
            return A2(
              ...
              _List_fromArray(
                [
                  $elm$html$Html$Attributes$class("token-block")
                ]
              ),
              A2(
                $elm$core$List$map,
                ...
                A2(
                  ...
                  A2(
                    ...
                    A2(
                      ...
                      $elm$core$Basics$ge(block.b)
                    ),
                    $elm$core$Dict$keys(model.lines)
                  )
                )
              )
            );
        ...
        var $author$project$Main$BlockT = { $: "BlockT" };
        var $author$project$Main$LineT = { $: "LineT" };
        ...
        var $author$project$Main$TempChanged = function(a) {
          return { $: "TempChanged", a };
        };
        ...
        var $author$project$Main$viewPropertyRow = F4(
          function(part, index, model, _v0) {
            var k = _v0.a;
            var v = _v0.b;
                          ...
                          [
                            $elm$html$Html$Events$onClick(
                              $author$project$Main$Edit(
                                A3($author$project$Main$PropValueT, part, index, k)
                              )
                            )
                          ]
                        ),
                    ...
                    [
                      A2(
                        ...
                        _List_fromArray(
                          [
                            $elm$html$Html$Events$onClick(
                              $author$project$Main$Remove(
                                A3($author$project$Main$PropKeyT, part, index, k)
                              )
                            )
                          ]
                        ),
            ...
            return A2(
              ...
              _List_Nil,
              function() {
                var _v1 = model.editingMeta;
                if (_v1.$ === "PropValueT") {
                  var p = _v1.a;
                  var i = _v1.b;
                  var k_ = _v1.c;
                  return _Utils_eq(p, part) && (_Utils_eq(i, index) && _Utils_eq(k_, k)) ? _List_fromArray(
                    [
                      A2(
                        $elm$html$Html$td,
                        _List_Nil,
                        ...
                        _List_fromArray(
                          [
                            A2(
                              ...
                              _List_fromArray(
                                [
                                  $elm$html$Html$Attributes$value(model.temp),
                                  $elm$html$Html$Events$onInput($author$project$Main$TempChanged),
                          ...
                          [
                            A2(
                              ...
                              _List_fromArray(
                                [
                                  $elm$html$Html$Events$onClick(
                                    $author$project$Main$Save(model.editingMeta)
                                  )
                                ]
                              ),
                              _List_fromArray(
        ...
        var $author$project$Main$viewProperties = F3(
          function(part, index, model) {
            var propSet = function() {
              switch (part.$) {
                case "TextT":
                  return $elm$core$Maybe$Just(model.meta.properties);
                case "LineT":
                  return A2(
                    $elm$core$Maybe$map,
                    function($) {
            ...
            var properties = $elm$core$Dict$toList(
              A2($elm$core$Maybe$withDefault, $elm$core$Dict$empty, propSet)
            );
            var _default = A2(
              $elm$html$Html$button,
              _List_fromArray(
                [
                  ...
                  $elm$html$Html$Events$onClick(
                    $author$project$Main$Edit(
                      A3($author$project$Main$PropKeyT, part, index, "")
                    )
                  )
                ]
              ),
            ...
            return A2(
              ...
              _List_fromArray(
                [
                    ...
                    _List_fromArray(
                      [
                        ...
                        A2(
                          ...
                          A2(
                            $elm$core$List$map,
                            A3($author$project$Main$viewPropertyRow, part, index, model),
                            properties
                          )
                        )
                      ]
                  ...
                  function() {
                    var _v0 = model.editingMeta;
                    if (_v0.$ === "PropKeyT") {
                      var p = _v0.a;
                      var i = _v0.b;
                      return _Utils_eq(p, part) && _Utils_eq(i, index) ? A2(
                        $elm$html$Html$div,
                        _List_Nil,
                        _List_fromArray(
                          [
        ...
        var $author$project$Main$viewTagEditor = function(model) {
          return A2(
            $elm$html$Html$div,
            _List_Nil,
            _List_fromArray(
        ...
        var $author$project$Main$viewTagViewer = F3(
          function(part, index, model) {
            var tagSet = function() {
              switch (part.$) {
                case "TextT":
                  ...
                  A2(
                    ...
                    _List_fromArray(
                      [
                        $elm$html$Html$Events$onClick(
                          $author$project$Main$Edit(
                            A2($author$project$Main$TagsT, part, index)
                          )
                        ),
                        $elm$html$Html$Attributes$class("secondary")
                      ]
        ...
        var $author$project$Main$viewEditGrouping = F3(
          function(part, group, model) {
            var tags = function(_v2) {
              var k = _v2.a;
              var v = _v2.b;
              return A2(
                $elm$html$Html$li,
                  ...
                  [
                    function() {
                      ...
                      if (_v1.$ === "TagsT") {
                        var p = _v1.a;
                        var i = _v1.b;
                        return _Utils_eq(i, k) && _Utils_eq(part, p) ? $author$project$Main$viewTagEditor(model) : A3($author$project$Main$viewTagViewer, part, k, model);
                      } else {
                        return A3($author$project$Main$viewTagViewer, part, k, model);
                      }
                    }()
                  ]
                )
            ...
            var properties = function(_v0) {
              ...
              return A2(
                ...
                _List_fromArray(
                  [
                    A3($author$project$Main$viewProperties, part, k, model)
                  ]
                )
              );
            };
        ...
        var $author$project$Main$viewEditText = function(model) {
          return A2(
            $elm$html$Html$div,
            _List_Nil,
            _List_fromArray(
                ...
                A2(
                  ...
                  _List_fromArray(
                    [
                      ...
                      function() {
                        var _v0 = model.editingMeta;
                        if (_v0.$ === "TagsT" && _v0.a.$ === "TextT") {
                          var _v1 = _v0.a;
                          return $author$project$Main$viewTagEditor(model);
                        } else {
                          return A3(
                            $author$project$Main$viewTagViewer,
                            $author$project$Main$TextT,
                            _Utils_Tuple2(-1, -1),
                            model
                          );
                        }
                ...
                A2(
                  ...
                  _List_fromArray(
                    [
                      ...
                      A3(
                        $author$project$Main$viewProperties,
                        $author$project$Main$TextT,
                        _Utils_Tuple2(-1, -1),
                        model
                      )
                  ...
                  _List_fromArray(
                    [
                      A2(
                        ...
                        _List_fromArray(
                          [
                            $elm$html$Html$text("Original Text")
                          ]
                        )
                      ),
                      A2(
                        ...
                        _List_fromArray(
                          [
                            $elm$html$Html$Attributes$class("whitespace")
                          ]
                        ),
                        _List_fromArray(
                          [
        ...
        var $author$project$Main$viewEditPaneBody = function(model) {
          var _v0 = model.editPane;
          switch (_v0.$) {
            case "TextT":
              return $author$project$Main$viewEditText(model);
            case "BlockT":
              return A3(
                $author$project$Main$viewEditGrouping,
                $author$project$Main$BlockT,
                function($) {
                  return $.blocks;
                },
                model
            ...
            default:
              return $elm$html$Html$text("Cannot Edit This");
          }
        };
        var $author$project$Main$ChangeEditPane = function(a) {
          return { $: "ChangeEditPane", a };
        };
        var $author$project$Main$viewEditPaneHead = function(model) {
          return A2(
            $elm$html$Html$div,
            _List_fromArray(
              [
                      ...
                      $elm$html$Html$Attributes$classList(
                        _List_fromArray(
                          [
                            ...
                            _Utils_Tuple2(
                              "secondary",
                              !_Utils_eq(model.editPane, $author$project$Main$TextT)
                            )
                          ]
                        )
                      ),
                      $elm$html$Html$Events$onClick(
                        $author$project$Main$ChangeEditPane($author$project$Main$TextT)
                      )
                    ]
                  ),
                  _List_fromArray(
                      ...
                      $elm$html$Html$Attributes$classList(
                        _List_fromArray(
                          [
                            ...
                            _Utils_Tuple2(
                              "secondary",
                              !_Utils_eq(model.editPane, $author$project$Main$BlockT)
                            )
                          ]
                        )
                      ),
                      $elm$html$Html$Events$onClick(
                        $author$project$Main$ChangeEditPane($author$project$Main$BlockT)
                      )
                    ]
                  ),
                  _List_fromArray(
                      ...
                      $elm$html$Html$Attributes$classList(
                        _List_fromArray(
                          [
                            ...
                            _Utils_Tuple2(
                              "secondary",
                              !_Utils_eq(model.editPane, $author$project$Main$LineT)
                            )
                          ]
                        )
                      ),
                      $elm$html$Html$Events$onClick(
                        $author$project$Main$ChangeEditPane($author$project$Main$LineT)
                      )
                    ]
                  ),
                  _List_fromArray(
        ...
        var $author$project$Main$viewEditPane = function(model) {
          return A2(
            $elm$html$Html$div,
            _List_Nil,
            _List_fromArray(
              [
                $author$project$Main$viewEditPaneHead(model),
                $author$project$Main$viewEditPaneBody(model)
              ]
            )
          );
        };
        var $author$project$Main$viewRangeEditor = function(sel) {
          return _List_Nil;
        };
        var $author$project$Main$InsertToken = function(a) {
          return { $: "InsertToken", a };
        };
        var $author$project$Main$Merge = F2(
          function(a, b) {
            return { $: "Merge", a, b };
          }
        );
        var $author$project$Main$RemoveToken = function(a) {
          return { $: "RemoveToken", a };
        };
        ...
        var $author$project$Main$SwapTokenLeft = function(a) {
          return { $: "SwapTokenLeft", a };
        };
        var $author$project$Main$SwapTokenRight = function(a) {
          return { $: "SwapTokenRight", a };
        };
        var $author$project$Main$TokenStringChanged = F2(
          function(a, b) {
            return { $: "TokenStringChanged", a, b };
          }
        );
        var $author$project$Main$viewSingleEditor = function(token) {
          return _List_fromArray(
            [
              A2(
                $elm$html$Html$input,
                _List_fromArray(
                  [
                    $elm$html$Html$Attributes$value(token.string),
                    $elm$html$Html$Attributes$type_("text"),
                    $elm$html$Html$Events$onInput(
                      $author$project$Main$TokenStringChanged(token.identifier)
                    )
                  ]
                ),
                _List_Nil
                        ...
                        [
                          A2(
                            ...
                            _List_fromArray(
                              [
                                $elm$html$Html$Events$onClick(
                                  $author$project$Main$RemoveToken(token.identifier)
                                )
                              ]
                            ),
                            _List_fromArray(
                          ...
                          A2(
                            ...
                            _List_fromArray(
                              [
                                $elm$html$Html$Events$onClick(
                                  $author$project$Main$InsertToken(token.identifier)
                                )
                              ]
                            ),
                            _List_fromArray(
                          ...
                          A2(
                            ...
                            _List_fromArray(
                              [
                                $elm$html$Html$Events$onClick(
                                  $author$project$Main$SwapTokenLeft(token.identifier)
                                )
                              ]
                            ),
                            _List_fromArray(
                              [
                                $elm$html$Html$text("Swap Left")
                              ]
                            )
                          ),
                          A2(
                            ...
                            _List_fromArray(
                              [
                                $elm$html$Html$Events$onClick(
                                  $author$project$Main$SwapTokenRight(token.identifier)
                                )
                              ]
                            ),
                            _List_fromArray(
                              [
                                $elm$html$Html$text("Swap Right")
                              ]
                            )
                          )
                        ]
                ...
                _List_fromArray(
                  [
                    A2(
                      ...
                      _List_fromArray(
                        [
                          $elm$html$Html$text("Edit Grouping")
                        ]
                      )
                    ),
                    A2(
                        ...
                        [
                          A2(
                            ...
                            _List_fromArray(
                              [
                                $elm$html$Html$Events$onClick(
                                  A2($author$project$Main$Split, $author$project$Main$BlockT, token.identifier)
                                )
                              ]
                            ),
                            _List_fromArray(
                              [
                                $elm$html$Html$text("Split Block")
                              ]
                            )
                          ),
                          A2(
                            ...
                            _List_fromArray(
                              [
                                $elm$html$Html$Events$onClick(
                                  A2($author$project$Main$Split, $author$project$Main$LineT, token.identifier)
                                )
                              ]
                            ),
                            _List_fromArray(
                              [
                                $elm$html$Html$text("Split Line")
                              ]
                            )
                          ),
                          A2(
                            ...
                            _List_fromArray(
                              [
                                $elm$html$Html$Events$onClick(
                                  A2($author$project$Main$Merge, $author$project$Main$BlockT, token.identifier)
                                )
                              ]
                            ),
                            _List_fromArray(
                              [
                                $elm$html$Html$text("Merge Block")
                              ]
                            )
                          ),
                          A2(
                            ...
                            _List_fromArray(
                              [
                                $elm$html$Html$Events$onClick(
                                  A2($author$project$Main$Merge, $author$project$Main$LineT, token.identifier)
                                )
                              ]
                            ),
                            _List_fromArray(
                              [
                                $elm$html$Html$text("Merge Line")
                              ]
                            )
                          )
                        ]
        ...
        var $author$project$Main$viewEditorPanel = function(model) {
          var _v0 = model.editing;
          if (_v0.$ === "Just") {
            if (_v0.a.$ === "Single") {
              var identifier = _v0.a.a;
              return A2(
                ...
                _List_fromArray(
                  [
                    $elm$html$Html$Attributes$class("token-edit-bar")
                  ]
                ),
                A2(
                  $elm$core$Maybe$withDefault,
                  ...
                  A2(
                    $elm$core$Maybe$map,
                    $author$project$Main$viewSingleEditor,
                    A2($elm$core$Dict$get, identifier, model.tokens)
                  )
                )
              );
            } else {
              ...
              return A2(
                ...
                $author$project$Main$viewRangeEditor(sel)
              );
            }
          } else {
            return $elm$html$Html$text("");
            ...
            $elm$core$Dict$isEmpty(model.tokens) ? _List_fromArray(
              [
                A2(
                  ...
                  _List_fromArray(
                    [
                      ...
                      $elm$html$Html$Events$onInput($author$project$Main$NewText)
                    ]
                  ),
                  _List_Nil
                ),
                A2(
                  ...
                  _List_fromArray(
                    [
                      $elm$html$Html$Events$onClick($author$project$Main$GenerateTokens)
                    ]
                  ),
                  _List_fromArray(
                    [
                      $elm$html$Html$text("Generate Tokens")
                    ]
                  )
                )
              ]
              ...
              [
                ...
                A2(
                  ...
                  _List_fromArray(
                    [
                      $elm$html$Html$Attributes$class("grid-with-side")
                    ]
                  ),
                  _List_fromArray(
                    [
                      ...
                      $author$project$Main$viewEditPane(model),
                      A2(
                        $elm$html$Html$div,
                        _List_Nil,
                        A2(
  ...
  var require_index = __commonJS({
    "client/index.js"() {
      ...
      var getDocSelection = () => {
        ...
        if (focus.classList.contains("token-cell") && anchor.classList.contains("token-cell")) {
          if (position == 2) {
            return JSON.stringify({
              left: Math.floor(anchor.id),
